...
import {MainNav, ComponentsNav, FormsNav, WidgetsNav, ChartsNav,Listsearch,StudentNav} from './NavItems';
    ...
    render() {
        return (
            <Fragment>
                ...
                <h5 className="app-sidebar__heading">ListSearch</h5>
                <MetisMenu content={Listsearch} activeLinkFromLocation className="vertical-nav-menu" iconNamePrefix="" classNameStateIcon="pe-7s-angle-down"/>
                <h5 className="app-sidebar__heading">Students</h5>
                <MetisMenu content={StudentNav} activeLinkFromLocation className="vertical-nav-menu" iconNamePrefix="" classNameStateIcon="pe-7s-angle-down"/>
            </Fragment>
        );
    }
